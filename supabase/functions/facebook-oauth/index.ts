...
serve(async (req) => {
  ...
  try {
    ...
    if (!code) {
      ...
      // Include all required permissions for Facebook Ads management including image management
      facebookAuthUrl.searchParams.append("scope", "ads_management,ads_read,business_management,pages_show_list,pages_read_engagement,ads_images:read,ads_images:write");
